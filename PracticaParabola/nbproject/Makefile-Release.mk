...
LDLIBSOPTIONS=-L/cygdrive/C/opencv/build/x64/vc11/bin -L/cygdrive/C/opencv/build/x64/vc11/lib
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/practicaparabola.exe: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/practicaparabola ${OBJECTFILES} ${LDLIBSOPTIONS} 
